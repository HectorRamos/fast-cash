                 ...
                 <div class="mar_che_cobrar2">                 
                    <div class="row">
                       <div class="form-group col-md-12">
                        ...
                        <label for="txtNombre">Seleccionar el tipo de acceso</label>
                          <select id="idPermiso" name="idPermiso" onchange="validar(this.value)" class="select" data-placeholder="Elige un credito..." required data-parsley-required-message="Por favor, seleccione un credito">
                  ...
                  <div class="row">
                    <div id="divPermiso" style="display: none;">
                         ...
                         <div class="col-md-12 col-sm-12 col-xs-12">
                          <div class="margn">
                            <table class="table">
                              ...
                              <td class="td td1">
                                 <input type="checkbox" name="menu[]" id="menu" class="checkbox" value="<?= $menu->idMenu?>">
                              </td>
                              </tr>
                              <?php
                              }
                      ...
                      <button type="submit" class="btn btn-success waves-effect waves-light m-d-5"><i class="fa fa-floppy-o fa-lg"></i> Asignar Permiso</button>
